...
#fdgs
	...
	@ echo "*************************************************"
	gcc -g -std=gnu99 -Wall -o OUTPUT/main_debug main.c ts_calibrate_common.c cJSON.c MTF_file.c dwDriver.c dwDriveD2.c DW_FileDecodeLib.c -lmingw32 -lSDL2main -lSDL2
	@ echo "<><><><><><>><><>><><><><><><><><><>><><><><><><>"
...
#fdgs
	...
	@ echo compiling iii $(DD) $(CC) $@
	@ echo "*************************************************"
	gcc -std=gnu99 -O3 -Wall -o OUTPUT/main_release main.c ts_calibrate_common.c cJSON.c MTF_file.c dwDriver.c dwDriveD2.c DW_FileDecodeLib.c -lmingw32 -lSDL2main -lSDL2
	@ echo "<><><><><><>><><>><><><><><><><><><>><><><><><><>"
